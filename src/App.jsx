    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/dashboard5" element={<ProtectedRoute><GenericDashboard title="Dashboard 5: Feasibility Tracking" description="Tracking the technical and operational feasibility of KPI implementation." dataKey="dashboard5" /></ProtectedRoute>} />
